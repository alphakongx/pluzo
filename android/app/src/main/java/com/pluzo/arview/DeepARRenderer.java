...
public class DeepARRenderer implements GLSurfaceView.Renderer {
    ...
    private EGLContext mEGLCurrentContext = null;
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (callInProgress && mEGLCurrentContext != null) {
            ...
            if (RtcEngineManager.Companion.getEngine() != null &&
                RtcEngineManager.Companion.getExistChannel()) {
               boolean success = RtcEngineManager.Companion.getEngine().pushExternalVideoFrame(frame);
                Log.e("Pushed Videos >>>", success ? "OK" : "FAIL");
            }
        }
    }
