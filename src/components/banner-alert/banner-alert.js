  ...
  return (
    <SafeAreaView>
      <Animated.View style={[styles.container, { transform: [{ translateY }] }]}>
        ...
        >
          <FastImage
            source={{ uri: props.notification.user.images[0].path }}
            style={[styles.userImage, styles.greenBorder]}
          />

          <View style={styles.textContainer}>
            <View style={styles.flexRow}>
              <Text style={styles.userName}>{props.notification.user.first_name}</Text>
