...
const LiveFilterSetting: () => React$Node = props => {
  ...
  const [liveSettings, setLiveSetttings] = useState(
    props.settings
      ? props.settings
      : { filter: 0, country: "Worldwide", state: "Alabama" },
  );
  ...
  useEffect(() => {
    if (props.settings !== null) {
      setLiveSetttings({
        ...
        state: props.settings.state === null ? "Alabama" : props.settings.state,
      });
  ...
  return (
    <View style={styles.container}>
      <Touchable style={styles.absoluteFill} onPress={() => goBack()}>
        <BlurView />
      </Touchable>
      ...
      <Screen hasGradient style={styles.filterContainer}>
        <SafeAreaView style={styles.container}>
          ...
          >
            ...
            <Image source={getFlag(liveSettings)} style={styles.flagIcon} />
            ...
            <View style={styles.locationContainer}>
              ...
              <View style={styles.locationRow}>
                ...
                <View style={styles.codePickerContainer}>
                  <CountryCodePicker
                    country={
                      liveSettings.country
                        ? { iso2: "", name: liveSettings.country }
                        : { iso2: "", name: "Worldwide" }
                    }
                    onChange={newCountry => {
