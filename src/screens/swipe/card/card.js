...
class Card extends React.Component {
  constructor(props) {
    ...
    if (this.props.card && this.props.card.images && this.props.card.images.length > 0) {
      FastImage.preload(
        this.props.card.images.map(item => ({
          uri: item.path
            ? item.path
          ...
          <View style={styles.tutorialContainer}>
            ...
            >
              ...
              <View style={styles.tutorialMarkHeart} pointerEvents={"box-none"}>
                <Text style={styles.heartText}>{"Swipe right to add"}</Text>
              </View>
            </Animated.View>
            <Animated.View
              style={[
            ...
            >
              ...
              <View style={styles.tutorialMarkCross} pointerEvents={"box-none"}>
                <Text style={styles.crossText}>{"Swipe left to pass"}</Text>
              </View>
            </Animated.View>
          </View>
        )}
