                ...
                <View style={styles.detailContainer}>
                  {[0, 1, 2].map(value => {
                    ...
                    if (this.props.purchasedMonths > 0) {
                      if (
                        this.props.purchasedMonths ===
                        this.state.periods[value].numberOfPeriod
                      ) {
                    ...
                    return (
                      <View style={styles.itemContainer} key={`select-period-${value}`}>
                        <BoxShadow setting={shadowItemOptions} />
                        <Touchable
                          onPress={() => {
                            if (disabled) {
                        ...
                        >
                          <Screen
                            ...
                            style={[
                              ...
                              !disabled && styles.itemActive,
                            ]}
                          >
                            <Text
                              style={[
                                styles.itemPeriodText,
                                !disabled && { color: "#FF7131" },
                              ]}
                            >
                              {this.state.periods[value].period}
                            </Text>
                            <Text style={styles.itemPopularText}>
                              {value == 1 ? "Most Popular" : ""}
                            </Text>
                            <Text style={styles.itemSaveText}>
                              {this.state.periods[value].saving}
                            </Text>
                            <Text style={styles.itemPriceText}>
                              {this.state.periods[value].fullprice}
                            </Text>
                            <View style={{ flex: 1 }} />
                        ...
                        <GradientButton
                          ...
                          textStyle={[
                            ...
                            !disabled && styles.itemActiveText,
                          ]}
                          containerStyle={[styles.selectButton]}
                          colors={
                            disabled ? ["#0B0516", "#1A023E"] : ["#FF7131", "#E0E552"]
                          }
                          shadowColor={"#FF6F00"}
          ...
          <View>
            <View style={styles.descriptionContainer}>
              ...
              <Text style={styles.descriptionContent}>
                By tapping Select, your payment will be charged to your iTunes account,
                and your subscription will automatically renew for the same package length
                at the same price until you cancel in settings in the iTunes Store at
                least 24 hours perior to the end of the current period. By tapping Select,
