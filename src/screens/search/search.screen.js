...
import { View, TextInput as RNTextInput, FlatList, ScrollView, ActivityIndicator } from "react-native";
          ...
          <View style={styles.filterContainer}>
            <FlatList
              ...
              renderItem={({ item: item, index }) => {
                return (
                  <Touchable
                    onPress={() => this.setState({currentFilter: item.id})}>
                    <View style={[styles.filterButtonContainer, item.id == currentFilter ? styles.activeButton : {}]}>
                  ...
                  <View style={styles.sectionContainer}>
                    <Text style={styles.sectionText}>Friends</Text>
                    {
                      friends.map((item, index) => {
                        ...
                        return (
                          <SearchPeopleItem friend item={item} />      
                        )
                      })
                    }
                    {
